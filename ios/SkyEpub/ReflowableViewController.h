...
-(void)reflowableViewController:(ReflowableViewController*)rvc insertHighlight:(Highlight*)highlight NS_SWIFT_NAME(reflowableViewController(_:didInsert:));
/** called when certain highlight should be deleted in the case like merging highlights. */
-(void)reflowableViewController:(ReflowableViewController*)rvc deleteHighlight:(Highlight*)highlight NS_SWIFT_NAME(reflowableViewController(_:didDelete:));
/** should return the number of pages for specific PagingInformation in global pagination mode*/
-(NSInteger)reflowableViewController:(ReflowableViewController*)rvc numberOfPagesForPagingInformation:(PagingInformation*)pagingInformation NS_SWIFT_NAME(reflowableViewController(_:numberOfPagesForPagingInformation:));

// 3.5.5
/** called when certain highlight should be updated in the case like changing color */
-(void)reflowableViewController:(ReflowableViewController*)rvc updateHighlight:(Highlight*)highlight NS_SWIFT_NAME(reflowableViewController(_:didUpdate:));
...
// 8.0
-(PagingInformation*)reflowableViewController:(ReflowableViewController*)rvc pagingInformationForPagingInformation:(PagingInformation*)pagingInformation NS_SWIFT_NAME(reflowableViewController(_:pagingInformationForPagingInformation:));
...
-(void)reflowableViewController:(ReflowableViewController*)rvc didDetectTapAtPosition:(CGPoint)position NS_SWIFT_NAME(reflowableViewController(_:didDetectTapAt:));
/** called when double tap is detected @param position CGPoint object at double tap position */
-(void)reflowableViewController:(ReflowableViewController*)rvc didDetectDoubleTapAtPosition:(CGPoint)position NS_SWIFT_NAME(reflowableViewController(_:didDetectDoubleTapAt:));
...
-(void)reflowableViewController:(ReflowableViewController*)rvc didHitHighlight:(Highlight*)highlight atPosition:(CGPoint)position startRect:(CGRect)startRect endRect:(CGRect)endRect NS_SWIFT_NAME(reflowableViewController(_:didHitHighlight:at:startRect:endRect:));
// 3.6.2
...
@property (nonatomic,retain) MediaOverlay* mediaOverlay;
...
-(void)gotoPageByHighlight:(Highlight*)highlight NS_SWIFT_NAME(gotoPage(highlight:));
...
-(BOOL)changeFontName:(NSString*)fontName fontSize:(NSInteger)fontSize;
/**  changes font name,size and lineSpacing of ReflowableViewController and reload the current chapter.*/
-(BOOL)changeFontName:(NSString *)fontName fontSize:(NSInteger)fontSize lineSpacing:(NSInteger)lineSpacing;
...
-(void)deleteHightlight:(Highlight*)highlight NS_SWIFT_NAME(deleteHightlight(_:));
...
-(Parallel*)getParallelByIndex:(int)parallelIndex NS_SWIFT_NAME(getParallel(index:));
...
-(void)gotoPageByChapterIndex:(int)ci hashLocation:(NSString*)hashLocation NS_SWIFT_NAME(gotoPage(chapterIndex:hashLocation:));
/** goto Page with NavPoint */
-(void)gotoPageByNavPoint:(NavPoint*)navPoint NS_SWIFT_NAME(gotoPage(navPoint:));
/** ReflowablableView init with start NavPoint index */
-(id)initWithStartNavPoint:(NavPoint*)np; // 5.2
...
-(void)markHighlight:(Highlight*)highlight NS_SWIFT_NAME(markHighlight(_ highlight:));
...
-(void)addContentModifier:(NSString*)target replaceWith:(NSString*)replacement forExtension:(NSString*)extension;
